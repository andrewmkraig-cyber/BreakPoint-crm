...
export const DEFAULT_RULES: readonly string[] = [
  ...
  "Do not bold ordinary outreach body copy. Structured drafts may use bold section headers and labels when the format rules call for them.",
  "Use bullets when the content is list-like or the requested format calls for them. Never bullet a simple conversational response.",
