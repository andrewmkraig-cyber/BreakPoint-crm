...
export function AiWorkspace({
  ...
  async function generateInterviewPrepDraft(
    ...
    try {
      ...
      // No score of any kind here. Interview Prep is a candidate-facing
      // email and nothing else; the recruiter-facing read on a candidate
      // lives in Call Prep, which is never emailed.
      setInterviewPrepOpen(false);
    } catch (err) {
