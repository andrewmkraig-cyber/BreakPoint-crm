...
export function DocumentDropzone({
  ...
  return (
    <div className="space-y-4">
      {(title || description) && (
        <div>
          {title && <h3 className="font-serif text-base font-semibold text-navy">{title}</h3>}
      ...
      <label
        ...
        className={cn(
          ...
          isDragging
            ? "border-brand bg-brand-tint/40 text-navy"
            : "border-border bg-muted/30 text-muted-foreground hover:border-brand/40 hover:bg-brand-tint/20",
        )}
      >
        {isBusy ? (
