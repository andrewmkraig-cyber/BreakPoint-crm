...
// RF raw payload tags) and flips it via toggleCandidateKept. Renders as
// the shared "keep" Button variant — filled chip when kept, neutral when
// not — so the on/off state reads at a glance without a separate
// indicator pill.
