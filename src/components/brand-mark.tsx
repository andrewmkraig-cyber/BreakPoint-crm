  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      <div className="leading-tight">
        <div className="font-serif text-base font-semibold tracking-wide text-navy dark:text-court-fg grass:text-court-fg">Ace</div>
        {withTag && <div className="text-[10px] uppercase tracking-[0.14em] text-court-fg-muted">BreakPoint Talent</div>}
      </div>
    </div>
  );
}
