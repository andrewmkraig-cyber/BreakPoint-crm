...
export function WeatherWidget() {
  ...
  return (
    ...
    >
      <div
        className="inline-flex h-10 cursor-default items-center gap-1 rounded-lg border border-court-border bg-court-surface-subtle px-2 text-court-fg shadow-sm"
